...
# xgboost e shap vêm do pyproject.toml na raiz do repo (Git Folder Serverless
# gerencia as dependências do repositório inteiro a partir dele — ver
# https://docs.databricks.com/aws/en/compute/serverless/notebooks/git-folder-serverless).
# Não é preciso %pip install aqui.
